{
  ...
  "Formulas": {
    ...
    "8,38": "ODATA(\"v_YBS規格文書_ワークフロー?$select=Who&$filter=YBSコード eq \"&IF(ISBLANK(E9),\"null\",\"'\"&E9&\"'\")&\" and 改正コード eq \"&IF(ISBLANK(J9),\"null\",J9)&\" and 状態 eq '承認済み'\")",
    ...
    "30,6": "ODATA(\"ユーザー情報ビュー?$select=氏名&$filter=ユーザー名 eq \"&IF(ISBLANK(AM6),\"null\",\"'\"&AM6&\"'\"))"
  }
}